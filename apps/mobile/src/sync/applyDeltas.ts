...
function fetchLocalRow(config: TableConfig, id: string): { updated_at?: string; version?: number } | null {
...
export function applyDeltas(deltas: SyncDelta[]): { applied: number; skipped: number; total: number } {
