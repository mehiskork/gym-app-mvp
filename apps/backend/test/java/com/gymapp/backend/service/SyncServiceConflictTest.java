...
class SyncServiceConflictTest {
        ...
        @Test
        void syncEndpointInsertsOpLedgerRow() {
                registerDevice("device-a", "token-a");
                ...
                SyncOp op = new SyncOp(
                                ...
                                "program-ledger",
                                "upsert",
                                payload("program-ledger", "device-a", "2024-07-01T00:00:00Z", "alpha"),
                                null);
                SyncRequest request = new SyncRequest(null, List.of(op));

                HttpHeaders headers = new HttpHeaders();
                headers.setBearerAuth("token-a");
