...
class DeviceTokenRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        repository = new DeviceTokenRepository(jdbcTemplate, passwordEncoder);
    }
    ...
    private record DeviceTokenRecordFixture(
        ...
        List<DeviceTokenRepository.DeviceTokenRecord> asRepositoryRecords() {
            return List.of(new DeviceTokenRepository.DeviceTokenRecord(tokenHash, deviceId, expiresAt, guestUserId));
        }

        List<DeviceTokenRepository.DeviceTokenRecord> append(DeviceTokenRecordFixture other) {
            return List.of(
                    new DeviceTokenRepository.DeviceTokenRecord(tokenHash, deviceId, expiresAt, guestUserId),
                    new DeviceTokenRepository.DeviceTokenRecord(
                            other.tokenHash, other.deviceId, other.expiresAt, other.guestUserId));
        }
    }
}
