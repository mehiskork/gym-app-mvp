...
class SyncAccountTransportIntegrationTest {
        ...
        @Test
        void syncRejectsInvalidBlankAccountOwnerIdAtResolverBoundary() throws Exception {
                AccountPrincipal invalidPrincipal = AccountPrincipal.builder()
        ...
        @Test
        void syncIgnoresExtraUnrecognizedFieldsAndStillProcessesOps() throws Exception {
                String opId = "op-extra-fields-1";
                String body = """
                                {
                                  "cursor":"0",
                                  "ignoredRoot":true,
                                  "ops":[
                                    {
                                      "opId":"%s",
                                      "entityType":"program",
                                      "entityId":"program-extra-fields-1",
                                      "opType":"upsert",
                                      "unexpectedField":"ignored-value",
                                      "payload":{
                                        "id":"program-extra-fields-1",
